          ...
          {activeSubTab === 'terms' && (
            <div className="space-y-6 animate-text delay-100">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-slate-600 leading-relaxed">
                ...
                <p>
                  Numerology analysis, predictions, spelling modifications, and compatibility scores are provided as self-empowerment tools. They represent the intuitive analysis and corporate guidance of Teiendraa K Meena and do not guarantee specific material outcomes.
                </p>
